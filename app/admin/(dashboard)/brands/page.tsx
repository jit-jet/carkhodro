...
import { getCarBrandsAdmin, getCarModelsAdmin, getPartsBrandsAdmin } from "@/actions/brands";
...
export default function AdminBrandsPage() {
  return (
    <div>
      <PageHeader title="برندها و خودروها" description="مدیریت مدل خودرو، مدل خودرو و برند قطعات" />
