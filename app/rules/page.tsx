...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    title: '۲. تعریف خدمات',
    body: [
      'کارخودرو یک پلتفرم فروش آنلاین قطعات یدکی خودروهای ایرانی و خارجی است. خدمات ارائه‌شده شامل فروش قطعات اصل، مشاوره فنی، ارسال به سراسر کشور و گارانتی اصالت کالا می‌شود.',
  ...
  },
  {
    ...
    body: [
      ...
      'شرایط گارانتی هر محصول بر اساس شرایط سازنده یا واردکننده است و در صفحه‌ی محصول درج شده است.',
    ],
  },
  {
    title: '۸. حریم خصوصی',
