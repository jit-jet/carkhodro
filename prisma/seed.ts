...
async function main() {
  ...
  const productSeeds: ProductSeed[] = [
    { sku: 'BSH-ENG-206-001', name: 'فیلتر روغن موتور اصلی بوش',       pbMock: 1, cmMock: 1,  catMock: 1, wholesalePrice: 85000,                  isOffer: false, stock: 34, sales: 1240, views: 4520, rating: 4.5, reviewCount: 128,  origin: 'آلمان', pack: 1,  carton: 12, isOriginal: true,
    ...
    { sku: 'ISC-ENG-405-002', name: 'واتر پمپ موتور ایساکو اصلی',       pbMock: 2, cmMock: 2,  catMock: 1, wholesalePrice: 1150000, isOffer: true,  stock: 12, sales: 340,  views: 1820, rating: 4.2, reviewCount: 43, origin: 'ایران', pack: 1,  carton: 6,  isOriginal: true,
    ...
    { sku: 'VAR-ENG-PRA-003', name: 'کیت کلاچ کامل سه‌پارچه واریان',    pbMock: 4, cmMock: 6,  catMock: 1, wholesalePrice: 1200000, isOffer: true,  stock: 8,  sales: 890,  views: 5240, rating: 4.6, reviewCount: 189, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: true,
    ...
    { sku: 'BSH-ENG-SMD-004', name: 'تسمه تایم با مجموعه کامل بوش',     pbMock: 1, cmMock: 3,  catMock: 1, wholesalePrice: 450000,  isOffer: true,  stock: 19, sales: 520,  views: 2800, rating: 4.3, reviewCount: 78, origin: 'آلمان', pack: 1,  carton: 6,  isOriginal: true  },
    { sku: 'MPK-ENG-206-005', name: 'گژپین موتور استاندارد مپکو',        pbMock: 7, cmMock: 1,  catMock: 1, wholesalePrice: 320000,                     isOffer: false, stock: 6,  sales: 280,  views: 1540, rating: 4.1, reviewCount: 32,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'KYN-ENG-TBA-006', name: 'فیلتر هوای موتور کیان‌پارت',       pbMock: 5, cmMock: 7,  catMock: 1, wholesalePrice: 75000,                      isOffer: false, stock: 47, sales: 1580, views: 6200, rating: 4.6, reviewCount: 91,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'TKN-ENG-DNA-007', name: 'کمربند تایم با کیت کامل تکنو',     pbMock: 6, cmMock: 4,  catMock: 1, wholesalePrice: 290000,  isOffer: true,  stock: 15, sales: 430,  views: 2100, rating: 4.3, reviewCount: 38, origin: 'ایران', pack: 1,  carton: 6,  isOriginal: false },
    { sku: 'ISC-ENG-PRA-008', name: 'واشر سرسیلندر موتور ایساکو',        pbMock: 2, cmMock: 6,  catMock: 1, wholesalePrice: 580000,                     isOffer: false, stock: 0,  sales: 190,  views: 1020, rating: 4.0, reviewCount: 24,  origin: 'ایران', pack: 1,  carton: 6,  isOriginal: true  },
    { sku: 'BSH-BRK-405-009', name: 'لنت ترمز جلو دیسکی بوش',           pbMock: 1, cmMock: 2,  catMock: 4, wholesalePrice: 420000,                     isOffer: false, stock: 22, sales: 720,  views: 3400, rating: 4.8, reviewCount: 74, origin: 'آلمان', pack: 2,  carton: 20, isOriginal: true,
    ...
    { sku: 'VAR-BRK-SMD-010', name: 'دیسک ترمز چرخ جلو واریان',          pbMock: 4, cmMock: 3,  catMock: 4, wholesalePrice: 850000, isOffer: true,  stock: 11, sales: 360,  views: 2250, rating: 4.5, reviewCount: 52, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'TKN-BRK-TBA-011', name: 'کمک فنر جلو گازی تکنو',             pbMock: 6, cmMock: 7,  catMock: 4, wholesalePrice: 920000, isOffer: true,  stock: 7,  sales: 490,  views: 2900, rating: 4.3, reviewCount: 78, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'FDK-BRK-PRA-012', name: 'لنت ترمز عقب کفشکی فدک',            pbMock: 8, cmMock: 6,  catMock: 4, wholesalePrice: 185000,                     isOffer: false, stock: 38, sales: 840,  views: 4100, rating: 4.2, reviewCount: 95,  origin: 'ایران', pack: 2,  carton: 20, isOriginal: false },
    { sku: 'KYN-BRK-SHN-013', name: 'روغن ترمز ایمنی ۵۰۰ میلی‌لیتر',    pbMock: 5, cmMock: 9,  catMock: 4, wholesalePrice: 95000,                      isOffer: false, stock: 25, sales: 660,  views: 3100, rating: 4.4, reviewCount: 58,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'NGK-ELC-206-014', name: 'شمع خودرو NGK اصلی',                pbMock: 3, cmMock: 1,  catMock: 3, wholesalePrice: 340000,                     isOffer: false, stock: 30, sales: 1100, views: 5500, rating: 4.4, reviewCount: 67, origin: 'ژاپن',  pack: 4,  carton: 40, isOriginal: true,
      desc: 'شمع خودرو NGK اصلی با فناوری الکترود ایریدیوم. احتراق بهتر، مصرف کمتر سوخت. فاصله الکترود: ۱.۱ میلی‌متر، رزوه: M14×1.25.' },
    { sku: 'BSH-ELC-405-015', name: 'دلکو کامل برق بوش',                 pbMock: 1, cmMock: 2,  catMock: 3, wholesalePrice: 2100000, isOffer: true,  stock: 4,  sales: 210,  views: 1380, rating: 4.5, reviewCount: 67, origin: 'آلمان', pack: 1,  carton: 4,  isOriginal: true  },
    { sku: 'BSH-ELC-SMD-016', name: 'سنسور اکسیژن لامبدا بوش',            pbMock: 1, cmMock: 3,  catMock: 3, wholesalePrice: 680000,  isOffer: true,  stock: 9,  sales: 380,  views: 2100, rating: 4.4, reviewCount: 56, origin: 'آلمان', pack: 1,  carton: 6,  isOriginal: true  },
    { sku: 'TKN-ELC-DNA-017', name: 'باتری ۶۰ آمپر تکنو',                pbMock: 6, cmMock: 4,  catMock: 3, wholesalePrice: 1850000,                    isOffer: false, stock: 14, sales: 570,  views: 3400, rating: 4.6, reviewCount: 83, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'MPK-ELC-SNA-018', name: 'چراغ جلو دو چشم کامل مپکو',         pbMock: 7, cmMock: 8,  catMock: 3, wholesalePrice: 1200000, isOffer: true,  stock: 6,  sales: 290,  views: 1750, rating: 4.1, reviewCount: 29, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'ISC-CLN-PRA-019', name: 'رادیاتور آب کامل ایساکو',            pbMock: 2, cmMock: 6,  catMock: 5, wholesalePrice: 1450000, isOffer: true,  stock: 5,  sales: 220,  views: 1580, rating: 4.7, reviewCount: 34, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: true  },
    { sku: 'KYN-CLN-206-020', name: 'ترموستات خنک‌کننده کیان‌پارت',       pbMock: 5, cmMock: 1,  catMock: 5, wholesalePrice: 180000,                     isOffer: false, stock: 28, sales: 480,  views: 2400, rating: 4.3, reviewCount: 48,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'FDK-CLN-SMD-021', name: 'شیلنگ رادیاتور بالایی فدک',          pbMock: 8, cmMock: 3,  catMock: 5, wholesalePrice: 95000,                      isOffer: false, stock: 41, sales: 680,  views: 3200, rating: 4.0, reviewCount: 62,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'TKN-CLN-TBA-022', name: 'پنکه رادیاتور برقی تکنو',            pbMock: 6, cmMock: 7,  catMock: 5, wholesalePrice: 750000,  isOffer: true,  stock: 10, sales: 310,  views: 1950, rating: 4.4, reviewCount: 37, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'BSH-OIL-206-023', name: 'روغن موتور ۴ لیتری ۵W40 بوش',       pbMock: 1, cmMock: 1,  catMock: 6, wholesalePrice: 580000,                     isOffer: false, stock: 60, sales: 2350, views: 8900, rating: 4.7, reviewCount: 215,  origin: 'آلمان', pack: 1,  carton: 6,  isOriginal: true,
    ...
    { sku: 'KYN-OIL-DNA-024', name: 'روغن گیربکس اتوماتیک کیان‌پارت',     pbMock: 5, cmMock: 4,  catMock: 6, wholesalePrice: 420000,  isOffer: true,  stock: 33, sales: 560,  views: 2800, rating: 4.4, reviewCount: 89,  origin: 'ایران', pack: 1,  carton: 6,  isOriginal: false },
    { sku: 'MPK-OIL-SHN-025', name: 'گریس چرخ ۵ کیلوگرمی مپکو',           pbMock: 7, cmMock: 9,  catMock: 6, wholesalePrice: 310000,                     isOffer: false, stock: 17, sales: 190,  views: 980,  rating: 4.2, reviewCount: 28,  origin: 'ایران', pack: 1,  carton: 6,  isOriginal: false },
    { sku: 'NGK-OIL-SNA-026', name: 'مایع ترمز DOT4 اصلی NGK',            pbMock: 3, cmMock: 8,  catMock: 6, wholesalePrice: 125000,                     isOffer: false, stock: 44, sales: 820,  views: 4100, rating: 4.5, reviewCount: 72,  origin: 'ژاپن',  pack: 1,  carton: 12, isOriginal: true  },
    { sku: 'TKN-BDY-405-027', name: 'برف‌پاک‌کن جلو کامل تکنو',           pbMock: 6, cmMock: 2,  catMock: 2, wholesalePrice: 185000,  isOffer: true,  stock: 23, sales: 740,  views: 4500, rating: 4.2, reviewCount: 112,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'ISC-BDY-PRA-028', name: 'آینه بغل چپ کامل ایساکو',             pbMock: 2, cmMock: 6,  catMock: 2, wholesalePrice: 650000,                     isOffer: false, stock: 9,  sales: 430,  views: 2300, rating: 4.3, reviewCount: 45, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: true  },
    { sku: 'VAR-BDY-SMD-029', name: 'گلگیر جلو اصلی واریان',               pbMock: 4, cmMock: 3,  catMock: 2, wholesalePrice: 980000, isOffer: true,  stock: 4,  sales: 180,  views: 1200, rating: 4.1, reviewCount: 23, origin: 'ایران', pack: 1,  carton: 4,  isOriginal: false },
    { sku: 'FDK-BDY-TBA-030', name: 'شیشه جلو اتاق STD فدک',               pbMock: 8, cmMock: 7,  catMock: 2, wholesalePrice: 2400000,                    isOffer: false, stock: 0,  sales: 95,   views: 780,  rating: 4.0, reviewCount: 12,  origin: 'ایران', pack: 1,  carton: 2,  isOriginal: false },
    { sku: 'BSH-FLT-DNA-031', name: 'فیلتر کابین تهویه هوا بوش',           pbMock: 1, cmMock: 4,  catMock: 8, wholesalePrice: 120000,  isOffer: true,  stock: 52, sales: 1050, views: 5200, rating: 4.6, reviewCount: 88,  origin: 'آلمان', pack: 1,  carton: 12, isOriginal: true  },
    { sku: 'KYN-FLT-206-032', name: 'فیلتر بنزین موتور کیان‌پارت',         pbMock: 5, cmMock: 1,  catMock: 8, wholesalePrice: 85000,                      isOffer: false, stock: 37, sales: 880,  views: 4300, rating: 4.3, reviewCount: 65,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'MPK-FLT-SHN-033', name: 'فیلتر روغن کلاچ مپکو',                pbMock: 7, cmMock: 9,  catMock: 8, wholesalePrice: 65000,                      isOffer: false, stock: 20, sales: 420,  views: 2100, rating: 4.1, reviewCount: 34,  origin: 'ایران', pack: 1,  carton: 12, isOriginal: false },
    { sku: 'NGK-FLT-SNA-034', name: 'فیلتر گازوئیل دیزل NGK',              pbMock: 3, cmMock: 8,  catMock: 8, wholesalePrice: 145000,  isOffer: true,  stock: 16, sales: 310,  views: 1580, rating: 4.5, reviewCount: 41,  origin: 'ژاپن',  pack: 1,  carton: 12, isOriginal: true  },
  ];
